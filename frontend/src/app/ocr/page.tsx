...
import { Image as ImageIcon, ArrowLeft, FileUp, Copy, Download } from 'lucide-react';
...
export default function OCRTool() {
  ...
  const downloadText = () => {
    ...
    a.href = url;
    a.download = `extracted_${imageFile?.name}.txt`;
    a.click();
  };
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xl font-bold">Image to Text (OCR)</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
          ...
          <p className="text-gray-500 mb-8">Upload an image and use local AI to extract the text instantly.</p>
          ...
          {!imageFile ? (
            ...
            <div className="max-w-lg mx-auto text-left">
              ...
              <div className="flex justify-between items-center">
                <button onClick={() => setImageFile(null)} className="text-gray-500 hover:text-gray-800 font-medium">Cancel</button>
                <button 
                  onClick={processOCR} 
            ...
            <div className="py-6 text-left">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <ImageIcon className="w-6 h-6 text-indigo-600" /> Extracted Text
                </h3>
              ...
              <div className="mt-8 text-center">
                <button onClick={() => { setExtractedText(''); setImageFile(null); }} className="text-gray-500 hover:text-indigo-600 font-medium">
