...
import { FileUp, ArrowLeft, Trash2, ArrowUp, ArrowDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xl font-bold">Merge PDF</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Select PDF files to merge</h2>
          <p className="text-gray-500 mb-8">Combine multiple PDFs into a single document entirely in your browser.</p>
          ...
          {!mergedPdfUrl ? (
            <>
              ...
              {files.length > 0 && (
                <div className="text-left bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8">
                  <h3 className="font-semibold mb-4 text-gray-700">Selected Files ({files.length})</h3>
              ...
              {files.length >= 2 && (
                ...
                >
                  {isMerging ? 'Merging...' : 'Merge PDFs Now'}
                </button>
              )}
            </>
          ) : (
            <div className="py-12">
              ...
              <h3 className="text-2xl font-bold mb-6 text-gray-900">PDFs Merged Successfully!</h3>
              <a 
                href={mergedPdfUrl} 
